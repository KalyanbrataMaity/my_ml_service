...
class MLAlgorithmStatus(models.Model):
    '''
    The MLAlgorithmStatus represnt status of the MLAlgorithm which can change during the time.

    Attributes:
        status: The status of the a;gorithm in the endpoint. Can be: testing, staging, production
        active: The boolean flag which point to currently active status
        created_by: The date of status creation
